...
namespace EcommerceSite.Controllers
{
    public class PaniersController : Controller
    {
        ...
        public PaniersController(EcommerceSiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Panier != null ? 
                          ...
                          Problem("Entity set 'EcommerceSiteContext.Panier'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,nombreArticle,total")] Panier panier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nombreArticle,total")] Panier panier)
        {
            if (id != panier.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EcommerceSiteContext.Panier'  is null.");
            }
            var panier = await _context.Panier.FindAsync(id);
            if (panier != null)
            {
